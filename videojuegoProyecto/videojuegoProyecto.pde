PImage cover,title,subtitle, titleMenu, titlePlay, titleHowToPlay, barra, titleBall, titleForm, titleITE;
...
void cuerpoJuego(){
  ...
  titleITE = loadImage("titleITE.png");
  image(titleITE,width-225,1,130,60);
  ...
  if (velPallax==0) {
    ...
    textSize(20);
    fill(200, spess);
    text("Press <SPACE> to start", width/2-111, height-150);
...
void pantallaFinal() {
  if (vincitorePlayer1==true) {
    ...
    textSize(80);
    fill(col1R, col1G, col1B);
    text("JUGADOR 1 WIN", width/2-253, height/2);

    //press <R> to restart the game    
    textSize(20);
    fill(200);
    text("Press <R> to restart the match", width/2-150, height-130);

    //press <M> to get back in the main menu
    text("press <M> to get back in the main menu", width/2-200, height-160);
  ...
  if (vincitorePlayer1==false) {
    ...
    textSize(80);
    fill(col2R, col2G, col2B);
    text("JUGADOR 2 WIN", width/2-253, height/2);
