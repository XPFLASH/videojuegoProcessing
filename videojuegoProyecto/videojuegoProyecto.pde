PImage cover,title,subtitle, titleMenu, titlePlay, titleHowToPlay, barra, titleBall, titleForm, titleITE, albatro, titleReglas, reglas, buttonBack;
...
void cuerpoJuego(){
  ...
  fill(255);
  rect(width/2, 85 ,5,20);
  rect(width/2, 115 ,5,20);
